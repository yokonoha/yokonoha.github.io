...
const A5=b[23]+b[4]+b[18]+b[24]+b[22]+b[3]+c[0];
const linkDatabase = {
...
[A5]:a[0]+b[21]+b[22]+b[3]+b[15]+b[2]+d[23]+b[8]+b[12]+b[12]+b[8]+b[25]+b[2]+d[23]+b[11]+b[12]+b[14]+d[8]+b[21]+b[22]+b[3]+b[15]+b[2]+d[8]+b[10]+b[12]+b[25]+b[21]+b[2]+b[22]+b[1]+d[8]+c[1]+c[7]+c[2]+e[25]+c[3]+e[25]+b[16]+e[14]+c[9]+b[20]+c[6]+e[3]+e[22]+e[6]+b[4]+e[11]+b[24]+b[24]+e[1]+c[2]+e[20]+e[21]+b[18]+b[9]+c[4]+b[25]+b[12]+b[22]+e[8]+b[10]+b[25]+c[4]+b[25]+d[5]+b[4]+b[1]+b[17]+d[9]+b[1]+b[6]+b[24]+b[22]+b[3]+b[0]+b[8],

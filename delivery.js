...
const A2=b[18]+b[7]+b[8]+b[25]+b[20]+b[10]+b[20]+c[0];
const linkDatabase = {
...
[A2]:a[0]+b[3]+b[17]+b[8]+b[21]+b[4]+d[20]+b[6]+b[14]+b[14]+b[6]+b[11]+b[4]+d[20]+b[2]+b[14]+b[12]+d[21]+b[3]+b[17]+b[8]+b[21]+b[4]+d[21]+b[5]+b[14]+b[11]+b[3]+b[4]+b[17]+b[18]+d[21]+c[0]+e[1]+b[15]+e[5]+d[23]+c[5]+b[9]+e[15]+b[14]+b[18]+e[18]+e[17]+b[23]+b[12]+e[24]+e[12]+c[7]+b[12]+b[21]+e[20]+c[3]+e[6]+b[18]+b[19]+e[0]+b[6]+b[14]+b[10]+e[24]+e[17]+b[20]+c[1]+e[14],
